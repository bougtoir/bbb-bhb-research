...
# Convert inline math (β, R², r, d, P) to Word OMML equations
...
word_count_run.text = f'{total_wc} (including references, tables and figure captions; JoPPP limit <= 6,000)'

doc.save(outpath)
print(f'\nSaved: {outpath}')

print(f'\nBody word count: {body_total}')
print(f'Total word count (incl. references, tables and captions): {total_wc} (JoPPP limit <= 6,000)')
print(f'Abstract word count: {abstract_total} (JoPPP limit: 300)')
